                ...
                <div class="box relative rounded-lg shadow-md">
                    ...
                    <div id="setting_tab" class="uk-switcher md:py-12 md:px-20 p-6 overflow-hidden text-black text-sm"> 
                                ...
                                <form action="{{ url('/profile-update', $user->id) }}" method="Post" enctype="multipart/form-data" >
                                    ...
                                    <div class="space-y-6">
                                        ...
                                        <div class="md:flex items-center gap-10">
                                            <label class="md:w-32 text-right"> Nom </label>
                                            <div class="flex-1 max-md:mt-4">
                                                <input id="nom" type="text" placeholder="{{$user->lastname}}" class="@error('nom') is-invalid @enderror lg:w-1/2 w-full" name="nom">
                                            </div>
                                        </div>
                                        @error('nom')
                                        ...
                                        <div class="md:flex items-center gap-10">
                                            <label class="md:w-32 text-right"> Prenom </label>
                                            <div class="flex-1 max-md:mt-4">
                                                <input id="prenom" type="text" placeholder="{{$user->firstname}}" class="@error('prenom') is-invalid @enderror lg:w-1/2 w-full" name="prenom">
                                            </div>
                                        </div>
                                        @error('prenom')
                                            <div class="text-primary" role="alert">{{ $message }}</div>
                                        ...
                                        <div class="md:flex items-center gap-10">
                                            ...
                                            <div class="flex-1 max-md:mt-4">
                                                <input id="email" type="email" placeholder="{{$user->email}}" class="@error('email') is-invalid @enderror w-full" name="email">
                                            </div>
                                        </div> 
                                        @error('email')
                                            <div class="text-primary" role="alert">{{ $message }}</div>
                                        ...
                                        <div class="md:flex items-center gap-10">
                                            ...
                                            <div class="flex-1 max-md:mt-4">
                                                <select id="sexe" name="sexe" class="!border-0 !rounded-md lg:w-1/2 w-full @error('sexe') is-invalid @enderror">
                                        ...
                                        <div class="md:flex items-start gap-10 " hidden>
                                            ...
                                            <div class="flex-1 flex items-center gap-5 max-md:mt-4">
                                                <img src={{asset("images/avatars/avatar-3.jpg")}} alt="" class="w-10 h-10 rounded-full">
                                ...
                                <div class="md:flex items-start gap-16">
                                    ...
                                    <div class="flex-1 space-y-4 interactive-effect max-md:mt-5">
                                        ...
                                        <div>
                                            <label class="inline-flex items-center">
                                              <input class="rounded" type="checkbox" checked name="checkbox2" value="3" />
                                              <span class="ml-3"> Someone liked my PUTs</span>
                                            </label>
                                        </div>
                        ...
                        <div>
                            ...
                            <div>
                                <form action="{{ url('/profile/reset', $user->id) }}" method="Post" enctype="multipart/form-data" >
                                    @csrf
                                    <div class="space-y-6 max-w-lg mx-auto">
                                        ...
                                        <div class="md:flex items-center gap-16 justify-between max-md:space-y-3">
                                            ...
                                            <div class="flex-1 max-md:mt-4">
                                                <input id="oldPassword" type="password" placeholder="******" class="@error('oldPassword') is-invalid @enderror w-full" name="oldPassword">
                                            </div>
                                        </div>
                                        @error('oldPassword')
                                            <div class="text-primary" role="alert">{{ $message }}</div>
                                        ...
                                        <div class="md:flex items-center gap-16 justify-between max-md:space-y-3">
                                            ...
                                            <div class="flex-1 max-md:mt-4">
                                                <input id="password" type="password" placeholder="******" class="@error('password') is-invalid @enderror w-full" name="password">
                                            </div>
                                        </div>
                                        @error('password')
                                            <div class="text-primary" role="alert">{{ $message }}</div>
                                        ...
                                        <div class="md:flex items-center gap-16 justify-between max-md:space-y-3">
                                            <label class="md:w-40 text-right"> Répéter le mot de passe </label>
                                            <div class="flex-1 max-md:mt-4">
                                                <input id="password_confirmation" type="password" placeholder="******" class="@error('password_confirmation') is-invalid @enderror w-full" name="password_confirmation">
                                            </div>
                                        </div>
