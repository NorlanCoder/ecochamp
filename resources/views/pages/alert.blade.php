                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body relative z-10">
                                        ...
                                        <div class="flex gap-2 justify-center">
                                            <a href="{{ url('/alert', $item->id) }}">
                                                <button type="button" class="button bg-secondery !w-auto">Voir</button>
                                            </a>
                                            <a href="https://www.facebook.com/sharer/sharer.php?u={{ urlencode(url('/alert', $item->id)) }}" target="_blank">
                                                <button type="button" class="button bg-secondery !w-auto">Partager</button>
                                            </a>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="side-list-item">
                                        ...
                                        <div class="flex-1">
                                            <a href="timeline.html">
                                                <h4 class="side-list-title">{{ $alert->user->lastname }} {{ $alert->user->firstname }}</h4>
                                            </a>
