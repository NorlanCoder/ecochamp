                    ...
                    <div class="lg:max-w-[680px] w-full">
                        ...
                        <div class="relative" uk-slideshow="animation: push; ratio: 7:5">
                            ...
                            <ul class="uk-slideshow-items overflow-hidden rounded-xl" uk-lightbox="animation: fade"> 
                                <li class="w-full">
                                    <a class="inline" href={{asset("images/product/product-1.jpg")}} data-caption="Caption 1"> 
                                        <img src={{asset("images/product/product-1.jpg")}} alt="" class="w-full h-full absolute object-cover insta-0">
                                    </a>
                                </li>
                                <li class="w-full">
                            ...
                            <ul class="flex justify-center gap-4 py-4 absolute w-full bottom-0">
                                <li uk-slideshow-item="0"><a href="#"> <img src={{asset("images/product/product-1.jpg")}} alt="" class="w-16 h-12 rounded"> </a></li>
                        ...
                        <ul class="uk-slider-items w-[calc(100%+10px)]" uk-scrollspy="target: > li; cls: uk-animation-scale-up; delay: 20;repeat:true">
                            ...
                            <li class="lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 pr-3">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body flex justify-between">
                                        <div class="flex-1">
                                            <a href="product-view-1.html"><p class="card-text text-black font-medium line-clamp-1"> Herbal </p> </a>
                            ...
                            <li class="lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 pr-3">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body flex justify-between">
                                        <div class="flex-1">
                                            <a href="product-view-1.html"><p class="card-text text-black font-medium line-clamp-1"> Parfum </p> </a>
                            ...
                            <li class="lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 pr-3">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body flex justify-between">
                                        <div class="flex-1">
                                            <a href="product-view-1.html"><p class="card-text text-black font-medium line-clamp-1"> Furniture </p> </a>
                            ...
                            <li class="lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 pr-3">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body flex justify-between">
                                        <div class="flex-1">
                                            <a href="product-view-1.html"><p class="card-text text-black font-medium line-clamp-1"> Electronic </p> </a>
                            ...
                            <li class="lg:w-1/5 md:w-1/4 sm:w-1/3 w-1/2 pr-3">
                                <div class="card uk-transition-toggle">
                                    ...
                                    <div class="card-body flex justify-between">
                                        <div class="flex-1">
                                            <a href="product-view-1.html"><p class="card-text text-black font-medium line-clamp-1"> Shampo </p> </a>
