<div>
    ...
    <div class="bg-white rounded-xl drop-shadow-xl sm:w-80 w-screen border-t dark:bg-dark3 dark:border-slate-600" id="chat__box"
        ...
        <div class="relative">
            ...
            <!-- Tabs -->
            <div class="page-heading bg-slate-50">
            ...
            <div class="uk-switcher overflow-hidden rounded-xl -mt-8" id="chat__tabs">
                <!-- Tab 1 -->
                <div class="space-y-3 p-3 text-sm font-medium h-[280px] overflow-y-auto">
                    @foreach (range(1, 6) as $i)
                        <a href="#" class="block">
                            <div class="flex items-center gap-3.5 rounded-lg p-2 hover:bg-secondary dark:hover:bg-white/10">
                                <img src="{{ asset('images/avatars/avatar-' . $i . '.jpg') }}" alt="" class="w-7 rounded-full">
                                <div> User {{ $i }} </div>
                            </div>
                        </a>
                    @endforeach
