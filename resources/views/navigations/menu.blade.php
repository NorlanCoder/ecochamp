        ...
        <div class="pr-4" data-simplebar>
            ...
            <nav id="side">
                ...
                <ul>
                    ...
                    <li class="@if(isset($page) && $page == "post") active @endif">
                        <a href="{{url('/poste')}}">
                            <img src={{asset("images/icons/group.png")}} alt="post" class="w-6">
                            <span> Post </span> 
                        </a>
                    </li>
                    <li class="@if(isset($page) && $page == "activite") active @endif">
                        <a href="{{url('/activity')}}">
                            <img src={{asset("images/icons/event.png")}} alt="activity" class="w-5">
                            <span> Activité </span> 
                        </a>
                    </li> 
                    <li class="@if(isset($page) && $page == "alert") active @endif">
                        <a href="{{url('/alert')}}">
                            <img src={{asset("images/icons/page.png")}} alt="alert" class="w-6">
                            <span> Alert </span> 
                        </a>
                    </li>
            ...
            @auth
                ...
                <nav id="side" class="font-medium text-sm text-black border-t pt-3 mt-2 dark:text-white dark:border-slate-800">
                    ...
                    <ul class="mt-2 -space-y-2" 
                        ...
                        <li class="@if(isset($page) && $page == "parametre") active @endif">
