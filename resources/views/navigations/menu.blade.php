                ...
                <ul>
                    ...
                    <li>
                        <a href="messages.html">
                            <img src={{asset("images/icons/message.png")}} alt="messages" class="w-5">
                            <span> messages </span> 
                        </a>
                    </li> 
                    <li>
                        <a href="video.html">
                            <img src={{asset("images/icons/video.png")}} alt="messages" class="w-6">
                            <span> video </span> 
                        </a>
                    </li>
                    <li>
                        <a href="event.html">
                            <img src={{asset("images/icons/event.png")}} alt="messages" class="w-6">
                            <span> event </span> 
                        </a>
                    </li>
                    <li>
                        <a href="pages.html">
                            <img src={{asset("images/icons/page.png")}} alt="pages" class="w-6">
                            <span> Pages </span> 
                        </a>
                    </li>
                    <li>
                        <a href="groups.html">
                            <img src={{asset("images/icons/group.png")}} alt="groups" class="w-6">
                            <span> Groups </span> 
                        </a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="blog.html">
                            <img src={{asset("images/icons/blog.png")}} alt="blog" class="w-6">
                            <span> blog </span> 
                        </a>
                    </li> 
                    <li class="!hidden" id="show__more">
                        <a href="games.html">
                            <img src={{asset("images/icons/game.png")}} alt="games" class="w-6">
                            <span> games </span> 
                        </a>
                    </li>
                    <li class="!hidden" id="show__more">
                        <a href="funding.html">
                            <img src={{asset("images/icons/fund.png")}} alt="messages" class="w-6">
                            <span> Fundraiser  </span> 
                        </a>
                    </li>
                    <li class="!hidden" id="show__more">
                        <a href="blog-2.html">
                            <img src={{asset("images/icons/blog-2.png")}} alt="blog" class="w-6">
                            <span> blog II </span> 
                        </a>
                    </li>
                    <li class="!hidden" id="show__more">
                        <a href="event-2.html">
                            <img src={{asset("images/icons/event-2.png")}} alt="event" class="w-6">
                            <span> Event II </span> 
                        </a>
                    </li>
                    <li class="!hidden" id="show__more">
                        <a href="groups-2.html">
                            <img src={{asset("images/icons/group-2.png")}} alt="groups" class="w-6">
                            <span> Groups II </span> 
                        </a>
                    </li>
