    ...
    <div class="flex items-center w-full xl:px-6 px-2 max-lg:gap-10">
        ...
        <div class="flex-1 relative">
            ...
            <div class="max-w-[1220px] mx-auto flex items-center">
                ...
                <div class="hidden uk- open z-10"
                        ...
                        <div class="xl:w-[694px] sm:w-96 bg-white dark:bg-dark3 w-screen p-2 rounded-lg shadow-lg -mt-14 pt-14">
                            ...
                            <nav class="text-sm font-medium text-black dark:text-white">
                                <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={{asset("images/avatars/avatar-2.jpg")}} class="w-9 h-9 rounded-full"> <div>   <div> Jesse Steeve </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={{asset("images/avatars/avatar-2.jpg")}} class="w-9 h-9 rounded-full"> <div>   <div>  Martin Gray </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={{asset("images/group/group-2.jpg")}} class="w-9 h-9 rounded-full"> <div>   <div>  Delicious Foods  </div>  <div class="text-xs text-rose-500 font-medium mt-0.5">  Group </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={{asset("images/group/group-1.jpg")}} class="w-9 h-9 rounded-full"> <div>   <div> Delicious Foods  </div>  <div class="text-xs text-yellow-500 font-medium mt-0.5">  Page </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                                <a href="#" class=" relative px-3 py-1.5 flex items-center gap-4 hover:bg-secondery rounded-lg dark:hover:bg-white/10"> <img src={{asset("images/avatars/avatar-6.jpg")}} class="w-9 h-9 rounded-full"> <div>   <div>  John Welim </div>  <div class="text-xs text-blue-500 font-medium mt-0.5">  Friend </div>   </div> <ion-icon name="close" class="text-base absolute right-3 top-1/2 -translate-y-1/2 "></ion-icon>  </a>  
                ...
                @auth
                    <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black">
                        ...
                        <div  class="rounded-full relative bg-secondery cursor-pointer shrink-0">
                            <img src={{asset("images/avatars/avatar-2.jpg")}} alt="" class="sm:w-9 sm:h-9 w-7 h-7 rounded-full shadow shrink-0"> 
                        </div>
                        <div  class="hidden bg-white rounded-lg drop-shadow-xl dark:bg-slate-700 w-64 border2"
                            ...
                            <a href="timeline.html">
                                <div class="p-4 py-5 flex items-center gap-4">
                                    <img src={{asset("images/avatars/avatar-2.jpg")}} alt="" class="w-10 h-10 rounded-full shadow">
                                    <div class="flex-1">
                        ...
                        <div class="flex items-center gap-2 hidden">
                            ...
                            <img src={{asset("images/avatars/avatar-2.jpg")}} alt="" class="w-9 h-9 rounded-full shadow">
                ...
                @guest
                    <div class="flex items-center sm:gap-4 gap-2 absolute right-5 top-1/2 -translate-y-1/2 text-black"> 
                        <button type="button" class="button text-white bg-primary"> <a href="{{route("login.create")}}"> Connexion </a></button>
                    </div>
                @endguest
