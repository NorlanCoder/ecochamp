<div class="bg-white rounded-xl shadow-sm text-sm font-medium border1 dark:bg-dark2">
    ...
    <div class="flex gap-3 sm:p-4 p-2.5 text-sm font-medium">
        <a href="timeline.html"> <img src={{asset($item->user->profile)}} alt="" class="w-9 h-9 rounded-full"> </a>  
        <div class="flex-1">
    ...
    <!-- post image -->
    <a href="#show-post" uk-toggle>
        <div class="relative w-full lg:h-96 h-full sm:px-4">
            <img src={{asset(Storage::url('app/'.$item->image1))}} alt="{{asset(Storage::url('app/'.$item->image1))}}" class="sm:rounded-lg w-full h-full object-cover">
        </div>
    </a>
